...
#define IDC_RADIO_GOTO_OPTREMEMBER    (IDD_GOLINE + 9)
#define IDC_RADIO_GOTO_OPTUSEPOSITION (IDD_GOLINE + 10)
#define IDC_RADIO_GOTO_OPTDEFAULT     (IDD_GOLINE + 11)
#define IDC_CHECK_GOTO_KEEPOPEN       (IDD_GOLINE + 12)
#define IDC_CHECK_GOTO_KEEPONTOP      (IDD_GOLINE + 13)
